...
def recompute_avg30_from_history(root=ROOT, verbose=True, details=None):
...
#   1) oxirgi AVG30_WINDOW kunning kamida C_KEEP_MIN_SOLD_DAYS kunida sotilgan (muntazam talab);
