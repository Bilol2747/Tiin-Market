...
- **Avtomatlashtirish:** GitHub Actions (`.github/workflows/sync.yml`) — jadval bo'yicha **kuniga 2 marta** (04:00 va 09:00 UTC = Toshkent vaqti bilan 09:00 va 14:00) avtomatik ishga tushadi (`main`ga push bo'lganda ham qo'shimcha ishga tushadi), natijani `main`ga o'zi commit+push qiladi.
...
- Savdo ko'rsatkichlari (daromad, cheklar, ABC taqsimot va h.k.) muntazam o'zgarib turadi (kuniga 2 marta, 09:00/14:00 Toshkent vaqti yangilanadi — Zakas/Kirim/Stock esa alohida, jonli Invan API orqali har so'rovda yangilanadi, bu jadvalga bog'liq emas) — aniq raqamlarni bu faylga yozib qo'yish o'rniga, kerak bo'lganda joriy `data_daily.json`/`index.html` ichidan o'qing.
