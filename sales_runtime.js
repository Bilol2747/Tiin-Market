...
function _p6ShowOverlay(name,detH,monthName,abc,mzCount,mzPageH){
  ...
  ov.innerHTML=`<div id="sp-ov-header" style="position:sticky;top:0;background:#fff;padding:14px 0 12px;border-bottom:1.5px solid #f0f0ec;margin-bottom:20px;z-index:2;display:flex;align-items:center;gap:12px;flex-wrap:nowrap;min-width:0;overflow:hidden">
