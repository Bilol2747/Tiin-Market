...
ORDER_UPSERT_SQL = (
    # DIQQAT: maqsad jadval nomi ataylab "sup_orders" (Turso'dagi ESKI
    # `supplier_orders` blob-jadvali bilan TO'QNASHMASLIGI uchun — o'sha
    # jadval jonli saytning eski pipeline'i tomonidan hali ham ishlatiladi,
    # unga tegib bo'lmaydi). Faqat SHU quyidagi INSERT — bizning YANGI,
    # normallashtirilgan jadvalimizga yozadi; Turso'dan O'QISH esa (pastda,
    # migrate_supplier_orders/migrate_clients ichida `turso_query(client,
    # "... FROM supplier_orders/clients_business")`) eski nom bilan qoladi,
    # chunki o'sha — manba (o'zgarishsiz o'qiladi, hech qachon yozilmaydi).
    "INSERT INTO sup_orders (id, external_id, created_at, d, expected_date,"
...
def migrate_clients(con, client):
    ...
    con.executemany(
        # Maqsad — "biz_clients" (yangi jadval), Turso'dagi eski
        # "clients_business" bilan to'qnashmasligi uchun (yuqoridagi izoh).
        "INSERT INTO biz_clients (id, tin, nom, tel, external_id, xarid, balans, guruh,"
