...
HEAVY_FIELDS = (
    ...
    "ovEffective",                      # qo'lda tuzatish (override) jonli-yangilangan qiymati
    "calcBaseA",                        # calcStock hisoblangan paytdagi Invan qoldig'i
                                        # (jonli delta uchun asos - backend/app.py)
)
